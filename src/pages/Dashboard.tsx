...
import TerritoryTable from "../theme/TerritoryTable";
import MainLayout from "../theme/layout/MainLayout";
import CamerasBlock from "../theme/CamerasBlock";
          ...
          <div className="state h-100">
            <div className="row align-items-center">
              <div className="col-xl-9 col-md-9">
                <h2 className="state__title">Камеры видеонаблюдения</h2>
              </div>
            ...
            <div className="mt-3">
              <h3>
                Весовой терминал : {terminalWeight ? terminalWeight : 0} кг
              </h3>
            </div>
            {/* <StateTable
